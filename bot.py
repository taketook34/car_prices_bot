...
async def simple_message(message):
    await message.answer('Привет, этот бот может посоветовать вам по какой цене лучше выставить свой автомобиль на основе уже существующих апредложений на рынке по вашей модели')
